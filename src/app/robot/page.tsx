      ...
      <main>
        <section className="relative">
          <div className="h-[300px] md:h-[400px] relative overflow-hidden">
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center text-white">
              <h1 className="text-4xl md:text-5xl font-bold">AI机器人</h1>
              <p className="mt-2 text-sm uppercase tracking-wider">AI Robot</p>
            </div>
          </div>
        </section>
        ...
        <div className="container-custom py-8 md:py-12">
          <div className="flex items-center text-sm text-gray-500 mb-4">
            ...
            <span className="mx-2">/</span>
            <span className="text-gray-800">AI机器人</span>
          </div>
        </div>
        ...
        <section className="container-custom pb-12 md:pb-20">
          <div className="mb-6">
            <div className="flex flex-wrap gap-2">
              ...
              <a href="/mobile.html" className="px-4 py-2 bg-gray-100 hover:bg-gray-200">智能手机</a>
              <a href="/robot.html" className="px-4 py-2 bg-[#2460f2] text-white">AI机器人</a>
            </div>
          </div>
